    ...
    <div class="modal-body">
      ...
      <div class="col-md-3">
        <div class="form-group">
          ...
          <div class="col-md-3">
              <div class="form-group">
              {!! Form::label('custom_field1', __('lang_v1.cnic') . ':') !!}
              {!! Form::text('custom_field1', null, ['class' => 'form-control','maxlength'=>'13',
              'placeholder' => __('lang_v1.cnic')]); !!}
              </div>
          </div>
      ...
      {{--</div>--}}
          ...
          <div class="col-md-3">
          <div class="form-group">
          {!! Form::label('custom_field2', __('lang_v1.stn') . ':') !!}
          {!! Form::text('custom_field2', null, ['class' => 'form-control',
          'placeholder' => __('lang_v1.stn')]); !!}
          </div>
          </div>
      <div class="clearfix"></div>
          <div class="col-md-12">
          ...
          <div class="col-md-6">
              <div class="form-group">
                  {!! Form::label('custom_field3', __('lang_v1.address'). ':') !!}
