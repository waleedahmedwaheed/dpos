        ...
        <table class="table bg-gray">
          <thead>
            <tr class="bg-green">
              ...
              <th>@lang('sale.tax')</th>
              <th>@lang( 'purchase.fed_amount' )</th>
          ...
          @foreach($purchase->purchase_lines as $purchase_line)
            <tr>
              ...
              <td><span class="display_currency" data-currency_symbol="true">{{ $purchase_line->item_tax * $purchase_line->quantity }} </span> <br/><small>@if($purchase_line->tax_id) ( {{ $taxes[$purchase_line->tax_id]}} ) </small>@endif</td>
