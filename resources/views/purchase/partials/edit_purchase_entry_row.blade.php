...
<div class="table-responsive">
    ...
    id="purchase_entry_table">
        <thead>
              <tr>
                ...
                <th class="{{$hide_tax}}">@lang( 'purchase.fed_amount' )</th>
    ...
    @foreach($purchase->purchase_lines as $purchase_line)
        <tr>
            ...
            <td class="{{$hide_tax}}">
                <span class="total_tax_amount">{{number_format($purchase_line->item_tax * $purchase_line->quantity, 2, $currency_details->decimal_separator, $currency_details->thousand_separator)}}</span>
            </td>
            <td class="{{$hide_tax}}">
            ...
            <td class="@if(!session('business.enable_editing_product_from_purchase')) hide @endif">
                ...
                number_format($purchase_line->variations->profit_percent, 2, $currency_details->decimal_separator, $currency_details->thousand_separator),
