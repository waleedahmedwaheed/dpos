      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('table_unit_price_label', 'Unit Price Excl FED', ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('table_subtotal_label', 'Subtotal Excl FED', ['class' => 'form-control',
              'placeholder' => __('lang_v1.subtotal_label') ]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('table_unit_price_tax_label', __('lang_v1.unit_price_label_tax') . ':' ) !!}
            {!! Form::text('table_unit_price_tax_label', 'Unit Price Incl FED', ['class' => 'form-control',
              'placeholder' => __('lang_v1.unit_price_label_tax') ]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
            {!! Form::label('table_subtotal_label_tax', __('lang_v1.subtotal_label_tax') . ':' ) !!}
            {!! Form::text('table_subtotal_label_tax', 'Subtotal Incl FED', ['class' => 'form-control',
              'placeholder' => __('lang_v1.subtotal_label_tax') ]); !!}
          </div>
        </div>
        <div class="col-sm-3">
          <div class="form-group">
