      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('table_unit_price_tax_label', $invoice_layout->table_unit_price_tax_label, ['class' => 'form-control',
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::text('table_subtotal_label_tax', $invoice_layout->table_subtotal_label_tax, ['class' => 'form-control',
