                ...
                <tr>
                    <td>
                        ...
                        <div class="col-sm-4">
                            ...
                            {!! Form::text('product_custom_field1', @num_format($product->product_custom_field1), ['class' => 'form-control input-sm dpp_list_price input_number', 'placeholder' => 'List Price', 'required']); !!}
                        </div>
                        <div class="col-sm-4">
