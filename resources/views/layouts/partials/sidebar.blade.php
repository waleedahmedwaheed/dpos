        ...
        @if(auth()->user()->can('purchase_n_sell_report.view') 
          ...
          <li class="treeview {{  in_array( $request->segment(1), ['reports']) ? 'active active-sub' : '' }}" id="tour_step8">
            ...
            <ul class="treeview-menu">
              ...
              @can('stock_details.view')
                <li class="{{ $request->segment(2) == 'stock-details' ? 'active' : '' }}" ><a href="{{action('ReportController@getStockDetails')}}"><i class="fa fa-hourglass-half" aria-hidden="true"></i>@lang('report.stock_details')</a></li>
              @endcan
