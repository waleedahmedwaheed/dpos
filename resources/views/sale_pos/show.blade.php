          ...
          <table class="table bg-gray">
            ...
            @foreach($sell->sell_lines as $sell_line)
              <tr>
                ...
                {{--<td>--}}
                  {{--<span class="display_currency" data-currency_symbol="true">{{ $sell_line->tax_amount }}</span>--}}
                ...
                <td>{{$sell_line->product_to}}</td>
                <td>{{$sell_line->product_ato}}</td>
              </tr>
