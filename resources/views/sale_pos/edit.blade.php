				...
				<div class="col-sm-6">
					<div class="form-group">
						<div class="input-group">
							...
							{!! Form::text('transaction_date', \Carbon\Carbon::parse($transaction->transaction_date)->format('m/d/Y H:i:s') , ['class' => 'form-control', 'id' => 'transaction_date_edit', 'readonly', 'required']); !!}
						</div>
					</div>
				</div>
				</div>
