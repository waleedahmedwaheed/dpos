...
//Route::middleware(['IsInstalled', 'auth', 'SetSessionData', 'language', 'timezone', 'IsActive'])->group(function () {
    ...
    Route::get('/reports/product-purchase-sale', 'ReportController@getProductPurchaseSale');
