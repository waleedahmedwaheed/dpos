            ...
            if (!empty($term)) {
                $contacts->where(function ($query) use ($term) {
                        $query->where('name', 'like', '%' . $term .'%')
                            ...
                            ->orWhere('contacts.custom_field1', 'like', '%' . $term .'%')
                            ->orWhere('contacts.custom_field2', 'like', '%' . $term .'%')
                            ->orWhere('contacts.custom_field3', 'like', '%' . $term .'%')
                            ->orWhere('contacts.custom_field4', 'like', '%' . $term .'%');
                });
            }
