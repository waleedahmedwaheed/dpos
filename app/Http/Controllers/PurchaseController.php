...
//                'purchase_price' => $this->productUtil->num_uf($purchase['purchase_price'], $currency_details)*$exchange_rate,
                'purchase_price' => $this->productUtil->num_uf($purchase['purchase_price'], $currency_details),
//                'item_tax'=>$this->productUtil->num_uf($purchase['item_tax'], $currency_details)*$exchange_rate,
                'item_tax'=>$this->productUtil->num_uf($purchase['item_tax'], $currency_details),
...
//                'purchase_price_inc_tax' => $this->productUtil->num_uf($purchase['purchase_price_inc_tax'], $currency_details)*$exchange_rate,
                'purchase_price_inc_tax' => $this->productUtil->num_uf($purchase['purchase_price_inc_tax'], $currency_details),
//                'profit_percent' => $this->productUtil->num_uf($purchase['profit_percent'], $currency_details),
                ...
                if ($enable_product_editing == 1) {
                    ...
                    $new_purchase_line['profit_percent'] = $purchase['profit_percent'];
...
//                $purchase_line->discount_percent = $this->productUtil->num_uf($purchase['discount_percent'], $currency_details);
                $purchase_line->purchase_price = $this->productUtil->num_uf($purchase['purchase_price'], $currency_details);
                $purchase_line->purchase_price_inc_tax = $this->productUtil->num_uf($purchase['purchase_price_inc_tax'], $currency_details);
                $purchase_line->item_tax = $this->productUtil->num_uf($purchase['item_tax'], $currency_details);
...
//                    $variation_data['pp_without_discount'] = $this->productUtil->num_uf($purchase['pp_without_discount'], $currency_details)*$exchange_rate;
                    ...
                    $variation_data['profit_percent'] = $purchase['profit_percent'];
