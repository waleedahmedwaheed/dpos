...
class BusinessUtil extends Util
{
    ...
    public function newBusinessDefaultResources($business_id, $user_id)
    {
        ...
        InvoiceLayout::create(['name' => 'Default',
                        ...
                        'table_unit_price_label' => 'Unit Price Excl FED',
                        'table_unit_price_tax_label' => 'Unit Price Incl FED',
                        'table_subtotal_label' => 'Subtotal Excl FED',
                        'table_subtotal_label_tax' => 'Subtotal Incl FED',
                        'date_label' => 'Date',
