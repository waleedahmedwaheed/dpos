$(document).ready( function(){
    ...
    $(document).on( 'change', '.purchase_quantity', function(){
        ...
        var unit_product_tax = __calculate_amount('percentage', tax_rate, purchase_before_tax);

        var total_tax_amount = unit_product_tax * quantity;
        ...
        row.find('.total_tax_amount').text(__currency_trans_from_en(total_tax_amount, false, true));
...
function update_purchase_entry_row_values( row ){
    if(typeof row != 'undefined'){
        ...
        var unit_cost_price_after_tax = __read_number(row.find('.purchase_unit_cost_after_tax'),true);
...
function update_inline_profit_percentage(row){
    ...
    //
    // var purchase_before_tax = __read_number(row.find('input.purchase_unit_cost'), true);
    // // var purchase_before_tax = __read_number(row.find('input.purchase_unit_cost_after_tax'), true);
    // var profit_percent = __get_rate(purchase_before_tax, default_sell_price_in_base_currency);
    // console.log(default_sell_price);
    // console.log(default_sell_price_in_base_currency);
    // console.log(exchange_rate);
    // console.log(purchase_before_tax);
