...
$(document).ready(function(){
    ...
    //If list price is changed
    $(document).on( 'change', 'input#product_custom_field1', function(e){
        ...
        var list_price = __read_number($('input#product_custom_field1'));
        var tax_amount = purchase_exc_tax*(tax_rate/100);

        // var purchase_inc_tax = __add_percent(purchase_exc_tax, tax_rate);
        var purchase_inc_tax = list_price + tax_amount;
	...
	$(document).on( 'change', 'input#profit_percent', function(e){
		...
		var selling_price_inc_tax = __add_percent(purchase_inc_tax, tax_rate);
		__write_number($('input#single_dsp_inc_tax'), selling_price_inc_tax);
	});
